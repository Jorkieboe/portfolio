export default {
    ...
    splashImages: [
        {type: 'image', src: '/public/images/verhalenvangers/storycatchers.jpg'},
        {type: 'image', src: '/public/images/verhalenvangers/organ.jpg'},
        {type: 'video', src: '/public/videos/verhalenvangers-licht.mp4'},
    ],
    content: [
        {
            title: "De tour",
