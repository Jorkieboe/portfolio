export default {
    ...
    aboutmeText: [
        "Mijn naam is Jorrik Dillisse, creatieve developer en technologist, gespecialiseerd in interactieve installaties, games en AI-toepassingen. Ik vind het leuk om technologie te gebruiken als middel om betekenisvolle ervaringen te ontwerpen en te bouwen, van fysieke installaties tot data-gedreven webapps.",
        "Met een achtergrond in Communicatie & Multimedia Design en een master in Data-Driven Design focus ik op het creëren van unieke interacties waar techniek en concept samenkomen."
    ]
}