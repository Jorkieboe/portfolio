export default {
    ...
    introText: "Mijn tweede grote opdracht was voor een tentoonstelling in het Hong Kong Science Museum over de toekomst in transport, eten, en dagelijks leven. Hiervoor heb ik gewerkt aan een aantal applicaties met Vue, Three.js, Unity en ledstrips",
    splashImages: [
    ...
    content: [
        ...
        },
        {
            ...
            text: `Ik heb voor chasing perfection een ondersteunende rol gehad, waarin ik hielp bij bepaalde onderdelen zoals UI en Testing. Deze interactive is een unity applicatie met een ai fitness die met je meekijkt via body tracking op een diepte camera.`,
