export default {
    ...
    content: [
        {
            title: "The tour",
            text: `The goal of the multimedia tour is to discover different places in the museum. The visitor is given a zoomed-in photo of a location. They had to find this place and answer a question on that location. Afterward, they enter an interaction to learn more about that place. These could be various interactions such as solving a puzzle, turning on the lights in the church, or listening to an audio story.`,
            media: { type: "image", src: "/images/verhalenvangers/church.jpg" }
        },
        {
            title: "Frontend",
            text: `The application is built in React Native. Although I already familiar with React, React Native is quite a step further to get all those native functions working. Moreover, besides various libraries to make certain interactives work. such as Three.js or a gesture plugin, there was also a complex system to manage the translations for texts, images, and videos. In this project, I spent the most of my time on the audio because the tablet had to notify the server when the playback finished. This caused problems if the audio failed to play or stopped prematurely.`,
